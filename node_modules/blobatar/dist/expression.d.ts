 ...
 */
import { type Palette, type Tint } from "./color";
import { bakePose, type Pose, type Posable } from "./morph";
/**
...
export interface Expression {
    ...
    readonly bake: <L extends Posable>(l: L, p: Pose) => {
        l: L;
        wrap: string;
    };
    /**
 ...
 * these numbers does.
 */
export declare function poseVars(p: Pose): Record<string, string>;
/**
 ...
 */
export declare function tintWith(pal: Palette, p: Pose, t: Tint): Palette;
/**
 ...
 */
export declare const heatTint: (pal: Palette, p: Pose) => Partial<Record<import("./color").ColorKey, string>>;
/**
 ...
 * the pair.
 */
export declare const mad: Expression;
/**
 ...
 */
export declare const surprised: Expression;
/**
 ...
 * eleven times over.
 */
export declare const wink: Expression;
/**
 ...
 */
export declare const sleepy: Expression;
/**
 ...
 */
export declare const smug: Expression;
/**
 ...
 */
export declare const unsure: Expression;
/**
 ...
 */
export declare const scared: Expression;
/**
 ...
 */
export declare const love: Expression;
/**
 ...
 * one.
 */
export declare const shy: Expression;
/**
 ...
 */
export declare const sick: Expression;
/**
 ...
 */
export declare const thinking: Expression;
